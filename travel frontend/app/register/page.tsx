    ...
    <div className="min-h-screen flex">
      ...
      <div className="hidden lg:flex lg:w-1/2 relative overflow-hidden">
        ...
        <svg className="absolute inset-0 w-full h-full" viewBox="0 0 800 1000">
          ...
          <motion.path
            d="M 0 200 Q 200 300 400 250 T 800 400"
            fill="none"
          ...
          />
          <motion.path
            d="M 0 400 Q 200 500 400 450 T 800 600"
            fill="none"
            stroke="url(#routeGrad)"
            strokeWidth="2"
            initial={{ pathLength: 0 }}
          ...
          />
          <motion.path
            d="M 0 600 Q 200 700 400 650 T 800 800"
            fill="none"
            stroke="url(#routeGrad)"
            strokeWidth="2"
            initial={{ pathLength: 0 }}
                ...
                <div className="space-y-4">
                  {roles.map((role) => (
                    <motion.button
                      ...
                      className="w-full p-5 rounded-xl border border-border hover:border-primary/50 bg-secondary/30 hover:bg-secondary/50 text-left transition-all group"
                    >
              ...
              >
                ...
                <form onSubmit={handleSubmit} className="space-y-5">
                  ...
                  <div>
                    ...
                    <div className="relative">
                      ...
                      <Input
                        ...
                        className="pl-12 h-12 bg-secondary/30 border-border focus:border-primary"
                        required
                      />
                    </div>
                  </div>
                  ...
                  <div>
                    ...
                    <div className="relative">
                      ...
                      <Input
                        ...
                        className="pl-12 pr-12 h-12 bg-secondary/30 border-border focus:border-primary"
                        required
                      />
                      <button
                        type="button"
                  ...
                  <Button
                    type="submit"
                    disabled={isLoading}
                    className="w-full h-12 bg-primary hover:bg-primary/90 text-primary-foreground text-lg font-semibold mt-6"
                  >
                    {isLoading ? (
                      <motion.div
                        animate={{ rotate: 360 }}
