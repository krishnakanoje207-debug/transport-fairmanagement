    ...
    <div className="min-h-screen flex">
      ...
      <div className="hidden lg:flex lg:w-1/2 relative overflow-hidden">
        ...
        <motion.div
          ...
          className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[300px] h-[300px] rounded-full border border-red-500/20"
        />
        ...
        <motion.div
          ...
          className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[200px] h-[200px] rounded-full border border-primary/20"
        />
        ...
        <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2">
          <motion.div
            ...
            className="w-24 h-24 rounded-2xl bg-gradient-to-br from-red-600 to-red-900 flex items-center justify-center"
          >
          ...
          >
            {adminFeatures.map((feature, i) => (
              <motion.div
                ...
                className="glass-card rounded-xl p-4 border border-red-500/10 hover:border-red-500/30 transition-colors"
              >
            ...
            >
              ...
              <form onSubmit={handleCredentialsSubmit} className="space-y-5">
                <div>
                  ...
                  <div className="relative">
                    ...
                    <Input
                      ...
                      className="pl-12 h-12 bg-secondary/30 border-border focus:border-red-500"
                      required
                    />
                  </div>
                </div>
                ...
                <div>
                  ...
                  <div className="relative">
                    ...
                    <Input
                      ...
                      className="pl-12 pr-12 h-12 bg-secondary/30 border-border focus:border-red-500"
                      required
                    />
                    <button
                      type="button"
                ...
                <Button
                  type="submit"
                  disabled={isLoading}
                  className="w-full h-12 bg-gradient-to-r from-red-600 to-red-800 hover:from-red-500 hover:to-red-700 text-white text-lg font-semibold"
                >
                  {isLoading ? (
                    <motion.div
                      animate={{ rotate: 360 }}
            ...
            >
              <div className="text-center mb-6">
                <motion.div
                  ...
                  className="w-20 h-20 rounded-2xl bg-gradient-to-br from-red-500/30 to-primary/30 flex items-center justify-center mx-auto mb-4 border border-red-500/30"
                >
              ...
              <form onSubmit={handle2FASubmit} className="space-y-5">
                <div>
                  <Input
                    ...
                    placeholder="000000"
                    maxLength={6}
                    className="h-16 text-center text-3xl tracking-[0.5em] bg-secondary/30 border-border focus:border-red-500 font-mono"
                    required
                  />
                </div>
