    ...
    <div className="min-h-screen flex">
      ...
      <div className="hidden lg:flex lg:w-1/2 relative overflow-hidden">
        ...
        <svg className="absolute inset-0 w-full h-full" preserveAspectRatio="none">
          ...
          <motion.path
            d="M -50 200 Q 200 100 300 300 T 600 400 T 900 200 T 1200 350"
            fill="none"
            stroke="url(#routeGradientPartner)"
            strokeWidth="3"
            strokeLinecap="round"
          ...
          />
          <motion.path
            d="M -50 500 Q 150 400 350 500 T 700 350 T 1000 500 T 1300 400"
            fill="none"
            stroke="url(#routeGradientPartner)"
            strokeWidth="2"
            strokeLinecap="round"
          ...
          >
            {features.map((feature, i) => (
              <motion.div
                ...
                className="glass-card rounded-xl p-4 hover:border-yellow-500/30 transition-colors"
              >
        ...
        >
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <div>
              ...
              <div className="relative">
                ...
                <Input
                  ...
                  className="pl-12 h-12 bg-secondary/30 border-border focus:border-yellow-500"
                  required
                />
              </div>
            </div>
            ...
            <div>
              ...
              <div className="relative">
                ...
                <Input
                  ...
                  className="pl-12 pr-12 h-12 bg-secondary/30 border-border focus:border-yellow-500"
                  required
                />
                <button
                  type="button"
            ...
            <Button
              type="submit"
              disabled={isLoading}
              className="w-full h-12 bg-gradient-to-r from-yellow-600 to-primary hover:from-yellow-500 hover:to-primary/90 text-white text-lg font-semibold"
            >
              {isLoading ? (
                <motion.div
                  animate={{ rotate: 360 }}
