        ...
        <div className="p-4 border-t border-sidebar-border">
          <div className="flex items-center gap-3 p-3 rounded-xl bg-sidebar-accent/50">
            ...
            <div className="flex-1 min-w-0">
              <p className="text-sm font-medium text-sidebar-foreground truncate">Raj Kumar</p>
              <p className="text-xs text-sidebar-foreground/60 truncate">Vehicle #127</p>
            </div>
          </div>
          <button className="w-full mt-3 flex items-center gap-3 px-4 py-3 rounded-xl text-destructive hover:bg-destructive/10 transition-colors">
