...
function FeatureCard({ icon: Icon, title, description, index, gradient }: FeatureCardProps) {
  return (
    <motion.div
      ...
      <div className="glass-card rounded-2xl p-8 h-full relative overflow-hidden">
        ...
        <div className="relative z-10">
          <motion.div
            ...
            className="w-14 h-14 rounded-2xl bg-primary/10 flex items-center justify-center mb-6 border border-primary/20 group-hover:border-primary/40 transition-colors"
          >
