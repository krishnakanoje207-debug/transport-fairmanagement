          ...
          <div className="relative rounded-3xl overflow-hidden">
            ...
            <div className="absolute inset-0 overflow-hidden">
              ...
              <motion.div
                ...
                className="absolute -bottom-1/2 -right-1/4 w-full h-full opacity-30"
                style={{
            ...
            <div className="relative z-10 py-16 px-6 md:py-24 md:px-12 text-center">
              ...
              <motion.h2
                ...
                className="text-3xl md:text-4xl lg:text-5xl xl:text-6xl font-bold text-foreground mb-6 text-balance max-w-4xl mx-auto"
              >
              ...
              >
                <Link href="/register">
                  <Button 
                    size="lg" 
                    className="bg-primary hover:bg-primary/90 text-primary-foreground px-10 h-14 text-lg animate-pulse-glow group"
                  >
                    Get Started Free
                ...
                <Link href="/login">
                  <Button 
                    size="lg" 
                    variant="outline" 
                    className="border-foreground/20 hover:bg-foreground/5 h-14 text-lg px-10"
                  >
                    Sign In
                  </Button>
                </Link>
