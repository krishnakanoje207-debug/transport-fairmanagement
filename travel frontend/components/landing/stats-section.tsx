...
function StatCard({ icon: Icon, value, suffix, label, description, delay }: StatProps) {
  return (
    <motion.div
        ...
        <div className="relative z-10">
          <div className="flex items-center gap-4 mb-6">
            <motion.div
              ...
              className="w-14 h-14 rounded-xl bg-primary/10 flex items-center justify-center border border-primary/20"
            >
