...
export function LiveMapView() {
  ...
  return (
    <div className="relative h-[400px] w-full bg-secondary/20 overflow-hidden">
      {/* Grid overlay */}
      <div 
      ...
      <svg className="absolute inset-0 w-full h-full" viewBox="0 0 800 400">
        ...
        {/* Active route */}
        <motion.path
          d="M 100 320 Q 200 280 300 250 T 500 180 T 700 100"
          fill="none"
        ...
        <motion.g
          ...
          animate={{ offsetDistance: `${pathProgress}%` }}
          transition={{ duration: 0.1 }}
          style={{
