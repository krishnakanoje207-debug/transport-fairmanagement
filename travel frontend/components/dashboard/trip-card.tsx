...
import { MapPin, Navigation, Clock, Phone, MessageSquare, AlertTriangle } from "lucide-react";
...
export function TripCard({ user }: { user: User }) {
  if (!user.currentTrip) {
    return (
    ...
    <div className="space-y-6">
      ...
      <div className="space-y-2">
        ...
        <div className="h-2 rounded-full bg-secondary overflow-hidden">
          <motion.div
            initial={{ width: 0 }}
            animate={{ width: `${user.currentTrip.progress}%` }}
